...
##Challenge 4
#####Okay, things get very messy below, but it's the best I could figure out... :/
```{r}
#Creating the character vector 'Superfamily_Lorisoidea', where each element is a string indicating the name of a Family (note the elements themselves are not assigned names)
